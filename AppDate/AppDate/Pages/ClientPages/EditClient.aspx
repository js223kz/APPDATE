<%@ Page Title="Redigera kund." Language="C#" MasterPageFile="~/Pages/Shared/Site.Master" AutoEventWireup="true" CodeBehind="EditClient.aspx.cs" Inherits="AppDate.Pages.ClientPages.EditClient" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:FormView  ID="EditClientFormView" runat="server"
    ItemType="AppDate.Model.BLL.Client"
    DefaultMode="Edit"
    DataKeyNames="ClientId"
    RenderOuterTable="false"
    SelectMethod="ClientFormView_GetItem"
    UpdateMethod="ClientFormView_UpdateItem">
    
        <EditItemTemplate>
            <section id="EditForm" class="editclientsection">
                <%--Name--%>
                ...
                <%--Save changes button--%>
                <div>
                    <asp:Button ID="EditClientButton" CommandName="Update" CssClass="editclientbutton" runat ="server" Text="Spara ändringar"/>
                </div>
            </section>
        </EditItemTemplate>
    </asp:FormView>
